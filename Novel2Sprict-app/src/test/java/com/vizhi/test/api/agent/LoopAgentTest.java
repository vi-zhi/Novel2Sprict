package com.vizhi.test.api.agent;
...
//                .build();
        ...
        // This agent runs inside the refinement loop, and is responsible for refining the document based on the
